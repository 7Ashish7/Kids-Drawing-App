package ak.student.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImageButtonCurrPaint = linearLayoutPaintColors[1] as ImageButton
        mImageButtonCurrPaint!!.setImageDrawable(
            ContextCompat.getDrawable(this, R.drawable.palette_selcted)
        )
        ...
        ibSave.setOnClickListener {
            if (isReadStorageAllowed()) {
                ...
                lifecycleScope.launch {
                    val flDrawingView: FrameLayout = findViewById(R.id.fl_d_v_container)
    ...
    private fun showDialog() {
        val bd = Dialog(this)
        bd.setContentView(R.layout.dialog_brush_size)
        bd.setTitle("Brush Size:")

        val smallBtn: ImageButton = bd.findViewById(R.id.small_brush)
        smallBtn.setOnClickListener {
            drawingView?.setSizeForBrush(10.toFloat())
            bd.dismiss()
        }
        val medBtn: ImageButton = bd.findViewById(R.id.medium_brush)
        medBtn.setOnClickListener {
            drawingView?.setSizeForBrush(20.toFloat())
            bd.dismiss()
        }
        val largeBtn: ImageButton = bd.findViewById(R.id.large_brush)
                ...
                try {
                    ...
                    val f = File(
                        externalCacheDir?.absoluteFile.toString() + File.separator
                                + "Kids Drawing App_" + System.currentTimeMillis() / 1000 + ".jpg"
                    )
